...
cls
echo ==============================================================================
echo  KV260 LED Project - PS+PL (Verilog)
echo ==============================================================================
echo.
echo  [1] Create and Build All (includes XSA export)
...
:GUI
echo.
if exist "kv260_led_ps_pl\kv260_led_ps_pl.xpr" (
    start "" "%VIVADO_BAT%" kv260_led_ps_pl\kv260_led_ps_pl.xpr
) else (
...
echo.
echo Cleaning...
if exist "kv260_led_ps_pl" rmdir /s /q kv260_led_ps_pl
